...
#define MAXCOLS 1728	/* Up to one "letter" page wide, and a bit */
#define MAXROWS 2400	/* up to one A4 page long */
...
#define WHASHA 3510	/* Hashing, used in g3read */
#define WHASHB 1178
#define BHASHA 293
#define BHASHB 2695
...
#ifdef	MAIN
/* Same tables used by both g3read and g3write, so must be global */
...
/* Should be in the GlobalData structure... but can't initialize arrays
 * there, so need to change these all to pointers... 
 */
extern struct tableentry extable[];
extern struct tableentry mbtable[];
extern struct tableentry tbtable[];
extern struct tableentry mwtable[];
extern struct tableentry twtable[];
