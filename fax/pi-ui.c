/*
 * X User Interface for the FAX Format plug-in.
 *
...
#include "g3.h"			/* G3-format-specific stuff */
#include "pi-fax.h"		/* Program-specific interface */
...
{
	static char *msg = 
		"FAX Format Import Module $Revision: 1.5 $\n\n"
		"Reads and writes raw G3-format FAX files --\n"
		"Just the thing for working on that idea from a client!\n"
		"Copyright (C) 1995, 1996 Darwin Open Systems,\n"
		"     R R #1, Palgrave, ON Canada L0N 1P0.\n"
		"     Email: info@darwinsys.com\n"
		"     WWW: http://www.uunet.ca/darwinsys\n\n"
		"Portions previously copyrighted by Adobe Systems Inc.\n"
		"and by Paul Haeberli <paul@sgi.com>.\n"
		"This is free software: copy as you like, but give credit."
		;
	Widget dlg;
